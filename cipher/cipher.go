...
func (e *NewCipher) Encrypt(data []byte, AES_KEY string, AES_IV string) (string, error) {
...
func (e *NewCipher) Decrypt(decryptText string, AES_KEY string, AES_IV string) ([]byte, error) {
